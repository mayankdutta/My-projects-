...
void account::create_account()
{
	...
	//Essentially, for std::cin statements you use ignore before you do a getline call,
	//because when a user inputs something with std::cin, they hit enter and a '\n' char gets into
	//the cin buffer. Then if you use getline, it gets the newline char instead of the string you want.
	//So you do a std::cin.ignore(1000,'\n') and that should clear the buffer up to the
...
int main()
{
	...
	do
	{
		...
		cin>>ch;
		system("cls");  //header file we use is stdlib.h
		switch(ch)
		{
		case '1':
			write_account();
